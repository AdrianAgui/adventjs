/**
  * Estamos en la fábrica de Santa Claus 🎅 creando regalos como si no hubiera un mañana.
    ...
    podemos cambiar cada carácter por otro. Pero tiene limitaciones 🥲: al reemplazar el carácter se debe mantener el orden, 
    ...
    Necesitamos una función que nos diga si podemos reconfigurar una máquina para que de un regalo pueda pasar a fabricar otro 
...
export default function canReconfigure(from, to) {
  ...
  return (
    hasOnlyOneAsignPerChar(fromChars, toChars) &&
    hasOnlyOneAsignPerChar(toChars, fromChars)
  );
}
